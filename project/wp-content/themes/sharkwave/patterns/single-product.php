...
<h2 class="wp-block-heading has-text-align-center" style="font-style:normal;font-weight:500"> <?php echo esc_html__( 'Single Product', 'sharkwave' ); ?> </h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading"><?php echo esc_html__( 'Related Products', 'sharkwave' ); ?></h2>
<!-- /wp:heading -->
