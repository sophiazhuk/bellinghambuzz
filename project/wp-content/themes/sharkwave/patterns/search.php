...
<h1 class="wp-block-heading has-text-align-center has-x-large-font-size" style="font-style:normal;font-weight:700"><?php echo esc_html__( 'News', 'sharkwave' ); ?></h1>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->
