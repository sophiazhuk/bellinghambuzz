...
<p><?php echo __('No results.', 'zummo');?></p>
<!-- /wp:paragraph -->
<!-- /wp:query-no-results -->
...
<h4 class="wp-block-heading"><?php echo __('Search', 'zummo');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo __('Latest Posts', 'zummo');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo __('Categories', 'zummo');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo __('Tags', 'zummo');?></h4>
<!-- /wp:heading -->
