...
<div class="location-container">
    ...
    <div class="location-content">
        ...
        <div class="location-left">
            ...
            <div class="location-meta">
                <div class="loc-type bubble">
                    <?php echo get_the_terms(get_the_ID(), 'location_type')[0]->name ?? 'N/A'; ?></div>
                ...
                <?php if (!empty($approved_by) && $approved_by !== 'N/A'): ?>
                    <div class="loc-approved bubble" style="border-color: <?php echo $border_color; ?>;">
                        <?php echo $approved_by; ?>'s Pick</div>
                <?php endif; ?>
    ...
    SELECT * FROM restaurants WHERE REPLACE(name, \"’\", \"'\") = REPLACE(%s, \"’\", \"'\")",
                $post_title
            ), ARRAY_A);
        ...
        <div class="location-right">
            ...
            <div class="restaurant-info">
                ...
                <ul>
                    <li><strong>Is it wheelchair accessible?</strong>
                        <?php echo isset($restaurant['accessible']) && $restaurant['accessible'] == 1 ? 'Yes' : 'No'; ?>
                    </li>
                    <li><strong>Can you bring your dog?</strong>
                        <?php echo isset($restaurant['dogs_allowed']) && $restaurant['dogs_allowed'] == 1 ? 'Yes' : 'No'; ?>
                    </li>
                    <li><strong>Does this place have a happy hour?</strong>
                        <?php echo isset($restaurant['happy_hour']) && $restaurant['happy_hour'] == 1 ? 'Yes' : 'No'; ?>
                    </li>
                    <li><strong>Is there outdoor seating?</strong>
                        <?php echo isset($restaurant['outdoor_seating_area']) && $restaurant['outdoor_seating_area'] == 1 ? 'Yes' : 'No'; ?>
                    </li>
                </ul>
            </div>
            <div class="info-buttons">
                <?php if (!empty($restaurant['website'])): ?>
                    <a href="<?php echo esc_url($restaurant['website']); ?>" target="_blank"
                        class="visit-website-button">Visit Website</a>
